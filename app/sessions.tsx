...
const SessionsScreen = () => {
  ...
  const handleDeleteTrainingSession = async (sessionId: string, sessionName: string) => {
    Alert.alert(
  ...
  const renderTrainingSession = ({ item }: { item: TrainingSession }) => (
    <View style={[styles.sessionCard, { backgroundColor: currentTheme.colors.surface }]}>
        ...
        {trainingSessions.length === 0 ? (
          ...
          <>
            <View style={styles.summaryContainer}>
              <Text style={[styles.summaryText, { color: currentTheme.colors.textSecondary }]}>
